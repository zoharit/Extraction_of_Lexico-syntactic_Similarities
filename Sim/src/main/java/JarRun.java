...
public class JarRun {
    ...
    public static void main (String [] args) throws FileNotFoundException, IllegalArgumentException, IOException {
        ...
        HadoopJarStepConfig hadoopJarStep = new HadoopJarStepConfig()
                .withJar("s3n://finalproject191/Sim.jar") // This should be a full map reduce application.
                .withMainClass("Sim")
                .withArgs("s3n://finalproject191/outputallfiles/", "s3n://finalproject191/output_Sim_all_negative/","https://www.cs.bgu.ac.il/~dsp191/wiki.files/negative-preds.txt");
